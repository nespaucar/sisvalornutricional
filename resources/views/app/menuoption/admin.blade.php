        ...
        <div class="card-box">
            ...
            <div class="row m-b-30">
                <div class="col-sm-12">
					...
					<div class="form-group">						
						{!! Form::select('menuoptioncategory_id', $cboCategoria, null, array('class' => 'form-control input-xs', 'id' => 'menuoptioncategory_id', 'onchange' => 'buscar(\''.$entidad.'\')', 'data-live-search' => 'true')) !!}
					</div>
					<div class="form-group">
...
<script>
	$(document).ready(function () {
		...
		$('#formBusquedaMenuoption :input[id="menuoptioncategory_id"]').selectpicker();
	});
</script>